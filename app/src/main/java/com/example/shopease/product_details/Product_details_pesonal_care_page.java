...
public class Product_details_pesonal_care_page extends Fragment {

    Button btn_user_product_details_personal_care_product_add_to_cart,btn_user_product_details_personal_care_product_buy_product;
    TextView user_product_details_personal_care_product_discription,user_product_details_personal_care_product_price,user_product_details_personal_care_product_name,user_product_details_personal_care_product_weight,user_product_details_personal_care_product_rating;
    ImageView user_product_details_personal_care_product_image;
    ImageView btn_user_product_details_personal_care_cart,btn_user_Product_details_personal_care_back,btn_profile_details_wishlist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_product_details_pesonal_care_page, container, false);


        btn_user_Product_details_personal_care_back = root.findViewById(R.id.btn_user_Product_details_personal_care_back);
        btn_user_product_details_personal_care_cart = root.findViewById(R.id.btn_user_product_details_personal_care_cart);
        user_product_details_personal_care_product_image = root.findViewById(R.id.user_product_details_personal_care_product_image);
        user_product_details_personal_care_product_discription = root.findViewById(R.id.user_product_details_personal_care_product_discription);
        user_product_details_personal_care_product_price = root.findViewById(R.id.user_product_details_personal_care_product_price);
        user_product_details_personal_care_product_name = root.findViewById(R.id.user_product_details_personal_care_product_name);
        user_product_details_personal_care_product_weight = root.findViewById(R.id.user_product_details_personal_care_product_weight);
        user_product_details_personal_care_product_rating = root.findViewById(R.id.user_product_details_personal_care_product_rating);
        btn_user_product_details_personal_care_product_buy_product = root.findViewById(R.id.btn_user_product_details_personal_care_product_buy_product);
        btn_user_product_details_personal_care_product_add_to_cart = root.findViewById(R.id.btn_user_product_details_personal_care_product_add_to_cart);
        btn_profile_details_wishlist = root.findViewById(R.id.btn_profile_details_wishlist);



        btn_user_Product_details_personal_care_back.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_user_product_details_personal_care_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//          Set the data to the views in this fragment
        user_product_details_personal_care_product_name.setText(name);
        user_product_details_personal_care_product_price.setText("₹" + price);
        user_product_details_personal_care_product_weight.setText(weight);
        user_product_details_personal_care_product_rating.setText(rating);
        user_product_details_personal_care_product_discription.setText(discription);
         Picasso.get().load(imageUrl).into(user_product_details_personal_care_product_image);


        btn_user_product_details_personal_care_product_buy_product.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btn_user_product_details_personal_care_product_add_to_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Get a reference to the Firebase Realtime Database
                FirebaseDatabase database = FirebaseDatabase.getInstance();
