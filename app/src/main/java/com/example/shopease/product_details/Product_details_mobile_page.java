...
public class Product_details_mobile_page extends Fragment {

    Button btn_user_product_details_product_add_to_cart,btn_user_product_details_product_buy_product;
    TextView user_product_details_product_discription,user_product_details_product_price,user_product_details_product_name,user_product_details_product_storage,user_product_details_product_rating,user_product_details_product_Emi,user_product_details_product_summary;
    ImageView user_product_details_product_image;
    ImageView btn_user_product_details_cart,btn_user_Product_details_back,btn_profile_details_wishlist;

    @SuppressLint("MissingInflatedId")
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_product_details_page, container, false);

        btn_user_Product_details_back = root.findViewById(R.id.btn_user_Product_details_back);
        btn_user_product_details_cart = root.findViewById(R.id.btn_user_product_details_cart);
        user_product_details_product_image = root.findViewById(R.id.user_product_details_product_image);
        user_product_details_product_discription = root.findViewById(R.id.user_product_details_product_discription);
        user_product_details_product_price = root.findViewById(R.id.user_product_details_product_price);
        user_product_details_product_name = root.findViewById(R.id.user_product_details_product_name);
        user_product_details_product_storage = root.findViewById(R.id.user_product_details_product_storage);
        user_product_details_product_rating = root.findViewById(R.id.product_details_rating);
        user_product_details_product_Emi = root.findViewById(R.id.user_product_details_product_Emi);
        user_product_details_product_summary = root.findViewById(R.id.user_product_details_product_Summary);
        btn_profile_details_wishlist = root.findViewById(R.id.btn_profile_details_wishlist);

        btn_user_product_details_product_buy_product = root.findViewById(R.id.btn_user_product_details_product_buy_product);

        btn_user_product_details_product_add_to_cart = root.findViewById(R.id.btn_user_product_details_product_add_to_cart);

        btn_user_Product_details_back.setOnClickListener(new View.OnClickListener() {
            @Override
...
// Query to check if the product is already in the wishlist
        ...
        btn_user_product_details_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                           Save the address information to Firebase
        ...
        btn_user_product_details_product_buy_product.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                intent_razor_pay.putExtra("storage" , storage);
...
//          Set the data to the views in this fragment
        user_product_details_product_name.setText(name);
        user_product_details_product_price.setText("₹" + price);
        user_product_details_product_storage.setText(storage+"GB");
        user_product_details_product_rating.setText(rating);
        user_product_details_product_discription.setText(discription);
        user_product_details_product_Emi.setText((float)emi+"/month");
        user_product_details_product_summary.setText(summary);
        Picasso.get().load(imageUrl).into(user_product_details_product_image);


        btn_user_product_details_product_add_to_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
